...
export function advanceYear(state: CareerState): CareerState {
  ...
  return {
    ...
    ...(!state.shownAFullTutorial && roster.length >= 21 ? [{
      ...
      body: '部員が20人を超えた。\n公式戦に連れて行けるのは20人まで（先発11＋ベンチ9）。\nあふれた選手は「招集外」になる。試合に出られないうえ、面倒を見る人間がいないので自主練頼みで伸びも鈍い。\nBチームコーチを雇えばBチームができて、その選手たちも指導を受けられるようになる（部員25人＋寮Lv2以上も必要）。\n誰を20人に入れるかは編成画面で決められる。',
    }] : []),
    ],
